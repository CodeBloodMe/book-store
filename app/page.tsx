    ...
    <>
      ...
      <section className="py-16 px-4 bg-[#f5f5f0]">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          {/* Main Title */}
          <h1 className="font-black leading-none mb-2 text-[#0a0a0a]" style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(36px, 10vw, 100px)', letterSpacing: '-0.02em' }}>
            ChapterOne
          </h1>
          
          {/* Subtitle */}
          <h2 className="text-xl md:text-2xl font-bold mb-4 uppercase tracking-wide text-[#0a0a0a]">
            Find Your Perfect Book
          </h2>
          
          <p className="text-base max-w-lg mx-auto text-[#555] mb-10">
          ...
          <div className="mt-8 flex items-center gap-4 w-full">
            ...
            <span className="text-xs font-bold uppercase tracking-widest text-[#aaa]">or describe it yourself</span>
            <div className="flex-1 h-px bg-[#ddd]" />
          </div>
          ...
          <div className="mt-4 text-center w-full">
            <Link
              href="/recommend"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-sm transition-all hover:-translate-y-0.5 bg-[#0a0a0a] text-[#f5e642] border-2 border-[#0a0a0a] shadow-[4px_4px_0_rgba(0,0,0,0.2)]"
            >
